...
urlpatterns = [
    ...
    path('new-list/', MovieList.as_view(), name='movie-list-new'),
    ...
    path('reviews/<str:username>/', UserReviews.as_view(), name='user-review-detail'),
    path('reviews/', UserReviewsQP.as_view(), name='user-review-detail'),
]
